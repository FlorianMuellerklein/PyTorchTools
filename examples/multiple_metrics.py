...
def main(args):
    ...
    def top_k(targets, preds):
        preds = torch.softmax(preds, -1)
        targets, preds = targets.cpu(), preds.detach().cpu()
        return top_k_accuracy_score(targets, preds, labels=list(range(10)))
